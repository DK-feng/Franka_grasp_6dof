import torch
from UCN.lib import networks
from UCN.tools.test_images import compute_xyz
...
class UCN:
    ...
    def __init__(self, camera_intrinsic, NUM_CLASS: int=2, DEVICE=torch.device('cuda:0'), PIXEL_MEANS=None):
        ...
        self.network_data = torch.load('UCN/data/checkpoints/seg_resnet34_8s_embedding_cosine_rgbd_add_sampling_epoch_16.checkpoint.pth')
