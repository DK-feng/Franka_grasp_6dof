...
from franka_grasp_rl_6dof.UCN.lib.fcn.test_dataset import test_sample
from franka_grasp_rl_6dof.UCN.lib.fcn.config import cfg, cfg_from_file, get_output_dir
import franka_grasp_rl_6dof.UCN.lib.networks
from franka_grasp_rl_6dof.UCN.lib.utils.blob import pad_im
from franka_grasp_rl_6dof.UCN.lib.utils import mask as util_
...
if __name__ == '__main__':
    ...
    for i in index_images:
        if os.path.exists(images_color[i]):
            ...
            print(type(out_label_refined))
            print(out_label.shape)
            print(out_label_refined.shape)
            print(torch.max(out_label_refined))
            print(torch.min(out_label_refined))
